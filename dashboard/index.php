...
<body>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i> Last Updated 2 minutes ago!
                        </div>
                    </div>
                </div>
                <!-- /.row -->
	...
	if(isset($_POST['submit'])){//to run PHP script on submit
		...
		if(count($_POST['check_list'])==1){
			$_SESSION['drilldownfile']='drilldown4.php';
			...
			$_SESSION['drilldownfile']='drilldown5.php';
			switch($_POST['horizontalaxis']) {
				case 'Product':
